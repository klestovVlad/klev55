...
for (const f of ['species.json', 'species-index.json', 'spots.json', 'rules.json', 'zones.geojson', 'gauges.json', 'water.json', 'advice.json', 'observations.geojson']) need(existsSync(`${D}/${f}`), `${f} missing`);
if (problems.length) {
