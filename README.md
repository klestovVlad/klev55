...
2. **Что здесь ловится и на что?** Тап по месту или водоёму — виды по шансу, способы, наживки, лайфхаки.
...
5. **Что за рыба?** 28 видов: фото с лицензией, как отличить, размеры, съедобность и описторхоз.
6. **Что взять?** Чек-листы по способу и сезону, безопасность на льду, клещи, гроза.
...
Погода: сетка Open-Meteo из ~33 точек по всему кругу, одним запросом; слой «Ветер и осадки» на карте показывает стрелки ветра, дождь и облачность на выбранный час. Живого уровня Иртыша в открытом доступе нет с 2024 года: показываем последнее измерение с датой. Правила Казахстана не включены, воды за границей серые.
