...
export const GEAR_KEY: KeyNode[] = [
  ...
  {
    id: 'plastic',
    question: 'Что у неё спереди?',
    options: [
      { label: 'Прозрачная или цветная лопатка', result: ['vobler'], hint: 'Смотрите код на брюшке или упаковке: F, SP, S и SR/MR/DR — выше есть расшифровка. Составное тело из двух-трёх частей — тоже воблер, просто с более широкой игрой.' },
      { label: 'Чашка-выемка или срезанная морда, лопатки нет', result: ['popper'], hint: 'Поверхностная приманка: на упаковке обычно F и глубина 0 м. Работает только по тихой воде над травой.' },
      { label: 'Острый нос без лопатки, тело плоское, петля на спине', result: ['balansir', 'vobler'], hint: 'Без лопатки и с петлёй на спине это раттлин или балансир; с петлёй на носу и плавающий — уокер, он в карточке поппера.' },
